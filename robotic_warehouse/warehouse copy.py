...
class Warehouse(gym.Env):
    ...
    def step(
        ...
        # print("Before actions:", [(agent.x, agent.y) for agent in self.agents]) #####################################change Logging Agent States and Actions:


        for agent, action in zip(self.agents, actions):
            # print(f"Agent {agent.id} performs: {action}")   #####################################change Logging Agent States and Actions:
            if self.msg_bits > 0:
        ...
        # print("After actions:", [(agent.x, agent.y) for agent in self.agents]) #####################################change Logging Agent States and Actions:
